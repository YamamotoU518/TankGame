...
namespace dxe {
	...
	//----------------------------------------------------------------------------------------
	std::vector<Shared<Mesh>> Mesh::CreateFromFileObj(const std::string& file_path, const float base_scale)
	{
	...
	std::vector<Shared<Mesh>> Mesh::CreateFromFileObjMV(const std::string& file_path, const float base_scale) {
