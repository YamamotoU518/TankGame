...
namespace dxe {
	...
	bool IsEnableFilePath(const char* file_name) {
		return ( FILE_PATH_DICTIONARY.end() != FILE_PATH_DICTIONARY.find(file_name) );
	}

	//------------------------------------------------------------------------------------------------------------------------------
	bool IsEnableFontPath(const char* font_name) {
		return (FONT_NAME_TO_PATH_DICTIONARY.end() != FONT_NAME_TO_PATH_DICTIONARY.find(font_name));
	}

	//------------------------------------------------------------------------------------------------------------------------------
	const char* GetPathFromFileName(const char* file_name) {
		auto it = FILE_PATH_DICTIONARY.find(file_name);
		if (it == FILE_PATH_DICTIONARY.end()) {
	...
	const char* GetPathFromFontName(const char* font_name) {
		auto it = FONT_NAME_TO_PATH_DICTIONARY.find(font_name);
		if (it == FONT_NAME_TO_PATH_DICTIONARY.end()) {
