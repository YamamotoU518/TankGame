...
namespace tnl {
	...
	//-----------------------------------------------------------------------------------------------------
	Vector3 Vector3::CreateScreenRay(const float screen_x, const float screen_y, const float screen_w, const float screen_h, const tnl::Matrix& view, const tnl::Matrix& proj) noexcept {
		...
		view_mat._11 = (screen_w * 0.5f);
		view_mat._22 = -1.0f * (screen_h * 0.5f);
		view_mat._33 = 1.0f;
		view_mat._41 = (screen_w * 0.5f);
		view_mat._42 = (screen_h * 0.5f);
		view_mat._43 = 0.0f;
