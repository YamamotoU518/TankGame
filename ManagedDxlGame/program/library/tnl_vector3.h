...
namespace tnl {
	...
	public :	
		...
		static Vector3 CreateScreenRay(const float screen_x, const float screen_y, const float screen_w, const float screen_h, const tnl::Matrix& view, const tnl::Matrix& proj) noexcept ;
