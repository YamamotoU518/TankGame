...
void gameMain(float delta_time) {
	...
	DrawFormatString(0, 0, -1, "65536 までの乱数 [ %d ]", i_random_value_A);
	DrawFormatString(0, 30, -1, "0 ～ 100 までの乱数 [ %d ]", i_random_value_B);
	DrawFormatString(0, 60, -1, "-100 から +100 までの乱数 [ %d ]", i_random_value_C);
	DrawFormatString(0, 90, -1, "-10.0 から +10.0 までの乱数 [ %f ]", f_random_value);
