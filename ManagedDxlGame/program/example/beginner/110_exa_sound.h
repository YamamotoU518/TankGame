...
void gameStart() {
	...
	bgm_handle = LoadSoundMem("resource/sound/example/bgm_sample_0.mp3", 1);
	se_handle = LoadSoundMem("resource/sound/example/se_sample_2.wav", 3);
...
void gameMain(float delta_time) {
	...
	DrawFormatString(0, 0, -1, "『Q』BGM 途中再生");
	DrawFormatString(0, 30, -1, "『W』BGM 停止");
	DrawFormatString(0, 60, -1, "『E』SE 再生");
