...
void gameMain(float delta_time) {
	...
	DrawFormatString((int)goal_x, 0, -1, "経過時間 : %.2f", ct);
	DrawFormatString((int)goal_x, 20, -1, "Enterキーでリセット");

	DrawFormatString(0, 150, -1, "UniformLerp");
	DrawFormatString(0, 200, -1, "SmoothLerp - 0");
	DrawFormatString(0, 250, -1, "SmoothLerp - 1");
	DrawFormatString(0, 300, -1, "SmoothLerp - 2");
	DrawFormatString(0, 350, -1, "AccelLerp - 0");
	DrawFormatString(0, 400, -1, "AccelLerp - 1");
	DrawFormatString(0, 450, -1, "AccelLerp - 2");
	DrawFormatString(0, 500, -1, "DecelLerp");
